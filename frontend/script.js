...
function renderAssistantResponse(data) {
  ...
  // Notify Talk to Doctor button
  if (data.severity === 'High' || data.emergency) {
    document.dispatchEvent(new CustomEvent('cureoSeverity', { detail: data.emergency ? 'Emergency' : data.severity }));
  }
}
